...
Table \ref{tab:robust} shows slightly reformatted results from the {\tt alert_eval} object, showing the mean cross-validated results of different rules.
...
print(xtable(alert_eval, caption ="Printed table of the tmp2 object.", 
